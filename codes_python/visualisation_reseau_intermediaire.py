...
numero_reseau=input("indique le numero du reseau à visualiser")
if os.path.isfile(os.path.join('Reseaux_intermediaires','Reseau_intermediaire_'+str(numero_reseau)+'.pkl')):
    ...
    print("il n'y a pas de fichier pour ce numéro, veuillez vérifier le fichier excel et lancer le script main.py")
