...
(:objects
	...
	S49 S50 S51 S52 S53 S54 S55 S56 S57 S58 S59 S60 S61 S62 S63 S64 S65 S66 S67 S68 - Secondary
	)
(:init
	(is-primary P70)
	(is-primary P69)
	...
	(available P69)
	(available P70)
	(buildable P69 S44)(buildable S44 P69)
	(buildable P69 S57)(buildable S57 P69)
	(buildable P69 S58)(buildable S58 P69)
	(buildable P70 S10)(buildable S10 P70)
	(buildable P70 S16)(buildable S16 P70)
	(buildable S14 S37)(buildable S37 S14)
	(buildable S15 S22)(buildable S22 S15)
	(buildable S21 S63)(buildable S63 S21)
	(buildable S28 S52)(buildable S52 S28)
	(buildable S32 S47)(buildable S47 S32)
	(buildable S33 S42)(buildable S42 S33)
	(buildable S35 S46)(buildable S46 S35)
	(buildable S43 S40)(buildable S40 S43)
	(buildable S44 S45)(buildable S45 S44)
	(buildable S45 S66)(buildable S66 S45)
	(buildable S53 S60)(buildable S60 S53)
	(buildable S56 S50)(buildable S50 S56)
	(buildable S57 S59)(buildable S59 S57)
	(buildable S59 S56)(buildable S56 S59)
	(buildable S62 S55)(buildable S55 S62)
	(buildable S67 S8)(buildable S8 S67)
	(buildable S7 S67)(buildable S67 S7)
	(buildable S8 S68)(buildable S68 S8)
	(buildable S9 S4)(buildable S4 S9)
	(feed S1 P70)
	(feed S10 S9)
	(feed S11 S10)
	(feed S12 S11)
...
(:goal (and 
	...
	(connected S51 S52)(connected S52 S51)
	(connected S50 S51)(connected S51 S50)
	(connected S56 S50)(connected S50 S56)
	(connected S59 S56)(connected S56 S59)
	(connected S57 S59)(connected S59 S57)
	(connected P69 S57)(connected S57 P69)
	...
	(connected S60 S61)(connected S61 S60)
	(connected S61 S64)(connected S64 S61)
	(connected S65 S64)(connected S64 S65)
	(connected S66 S65)(connected S65 S66)
	(connected S45 S66)(connected S66 S45)
	(connected S44 S45)(connected S45 S44)
	(connected P69 S44)(connected S44 P69)
	...
	(connected S48 S49)(connected S49 S48)
	(connected S47 S48)(connected S48 S47)
	(connected S32 S47)(connected S47 S32)
	(connected S31 S32)(connected S32 S31)
	(connected S30 S31)(connected S31 S30)
	(connected S29 S30)(connected S30 S29)
	(connected P69 S29)(connected S29 P69)
	...
	(closed S51 S52)(closed S52 S51)
	(closed S50 S51)(closed S51 S50)
	(closed S56 S50)(closed S50 S56)
	(closed S59 S56)(closed S56 S59)
	(closed S57 S59)(closed S59 S57)
	(closed P69 S57)(closed S57 P69)
	...
	(closed S65 S64)(closed S64 S65)
	(closed S66 S65)(closed S65 S66)
	(closed S45 S66)(closed S66 S45)
	(closed S44 S45)(closed S45 S44)
	(closed P69 S44)(closed S44 P69)
	...
	(closed S43 S40)(closed S40 S43)
	(closed S39 S43)(closed S43 S39)
	(closed S38 S39)(closed S39 S38)
	(closed S58 S38)(closed S38 S58)
	(closed P69 S58)(closed S58 P69)
	(closed P70 S1)(closed S1 P70)
	(closed S1 S2)(closed S2 S1)
	(closed S2 S3)(closed S3 S2)
	(closed S3 S9)(closed S9 S3)
	...
	(closed S48 S49)(closed S49 S48)
	(closed S47 S48)(closed S48 S47)
	(closed S32 S47)(closed S47 S32)
	(closed S31 S32)(closed S32 S31)
	(closed S30 S31)(closed S31 S30)
	(closed S29 S30)(closed S30 S29)
	(closed P69 S29)(closed S29 P69)
	(removed P69 S50)(removed S50 P69)
	(removed S14 S45)(removed S45 S14)
	(removed S15 S16)(removed S16 S15)
	(removed S16 S22)(removed S22 S16)
	(removed S20 S26)(removed S26 S20)
	(removed S21 S66)(removed S66 S21)
	(removed S28 S63)(removed S63 S28)
	(removed S3 S4)(removed S4 S3)
	(removed S32 S33)(removed S33 S32)
	(removed S34 S35)(removed S35 S34)
	(removed S38 S40)(removed S40 S38)
	(removed S41 S45)(removed S45 S41)
	(removed S42 S37)(removed S37 S42)
	(removed S44 S43)(removed S43 S44)
	(removed S46 S47)(removed S47 S46)
	(removed S51 S56)(removed S56 S51)
	(removed S52 S53)(removed S53 S52)
	(removed S55 S60)(removed S60 S55)
	(removed S56 S57)(removed S57 S56)
	(removed S57 S58)(removed S58 S57)
	(removed S58 S59)(removed S59 S58)
	(removed S59 S44)(removed S44 S59)
	(removed S6 S67)(removed S67 S6)
	(removed S61 S62)(removed S62 S61)
	(removed S66 S14)(removed S14 S66)
	(removed S67 S68)(removed S68 S67)
	(removed S7 S8)(removed S8 S7)
	(removed S8 S37)(removed S37 S8)
	(removed S8 S49)(removed S49 S8)
	(removed S9 S10)(removed S10 S9)
	)
)
)